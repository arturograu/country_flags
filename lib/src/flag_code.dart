...
class FlagCode {
  ...
  static const Map<List<String>, String> _flagCodesCurrencies = {
    ['AED']: 'ae',
    ['AFN']: 'af',
    ['ALL']: 'al',
    ['AMD']: 'am',
    ...
    ['VUV']: 'vu',
    ['WST']: 'ws',
    ['XAF']: 'cm', // Used by several Central African countries
    ['XCD']: 'ag', // East Caribbean Dollar - Antigua and others
    ['XOF']: 'sn', // Used by several West African countries
  ...
  static String? fromCurrencyCode(String currencyCode) =>
      _flagCodesCurrencies.entries
          .singleWhereOrNull(
            (entry) => entry.key.contains(currencyCode),
          )
          ?.value;
}
